...
def process_files(file_paths, y_min, y_max, cache_dir="cache"):
...
if __name__ == "__main__":
    ...
    visualize_histogram(all_hist_gpu, 500, y_min, y_max)  # 2D 히스토그램 시각화 (bin_set = 500)
